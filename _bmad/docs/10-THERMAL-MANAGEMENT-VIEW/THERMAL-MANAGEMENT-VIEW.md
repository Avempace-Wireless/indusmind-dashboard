...
- [App Sidebar](../components/layout/AppSidebar.vue) - Navigation menu
- [Admin Layout](../components/layout/AdminLayout.vue) - Main layout wrapper
- [i18n English](../i18n/en.json) - English translations
- [i18n French](../i18n/fr.json) - French translations
- [Router Config](../router/index.ts) - Route definitions
