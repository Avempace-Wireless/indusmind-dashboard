  ...
  const alerts = [
    {
      ...
      description: 'La puissance dépasse 500 kW depuis 5 minutes',
    ...
    },
    {
      ...
      description: 'Température dépasse le seuil de sécurité',
    ...
    },
    {
      ...
      equipmentId: 'eq-004',
      level: 'Medium',
      message: 'Équipement hors ligne',
      description: 'Perte de communication avec le compteur',
    ...
    },
    {
      ...
      equipmentId: 'eq-002',
      level: 'Low',
      message: 'Facteur de puissance bas',
      description: 'Facteur de puissance sous 0.85',
